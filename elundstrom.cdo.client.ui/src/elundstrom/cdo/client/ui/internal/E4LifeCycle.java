...
public class E4LifeCycle {
	...
	void postContextCreate(final IEventBroker eventBroker, final IEclipseContext workbenchContext) {
		System.out.println("postContextCreate(): " + workbenchContext); //$NON-NLS-1$
	...
	void preSave(IEclipseContext workbenchContext, MApplication mapp) {
		System.out.println("preSave(): " + workbenchContext); //$NON-NLS-1$
	}
	...
	void processAdditions(IEclipseContext workbenchContext, MApplication mapp) {
		...
		System.out.println("processAdditions: " + workbenchContext); //$NON-NLS-1$
	}
	...
	void processRemovals(IEclipseContext workbenchContext,
			MApplication application /*
										 ...
										 */ ) {
		System.out.println("processRemovals(): " + workbenchContext); //$NON-NLS-1$
